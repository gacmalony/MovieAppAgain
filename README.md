THIS APP FETCHES DATA WITH API BY RETROFIT LIBRARY, BRINGING THE RECENTLY SHARED OR POPULAR MOVIES. IF I COULD FIND FREE API TO FETCH THE CAFE OR RESTAURANT BY LOCATION, I'LL GONNA MAKE IMPROVED VERSION
